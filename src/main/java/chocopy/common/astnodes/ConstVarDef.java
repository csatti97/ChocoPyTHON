...
public class ConstVarDef extends Declaration {
    ...
    /**
     * AST for `VAR = VALUE` where VAR has a type annotation, and spanning source locations
     * [LEFT..RIGHT].
     */
    public ConstVarDef(Location left, Location right, TypedVar var, Literal value) {
        super(left, right);
        this.var = var;
        this.value = value;
    }
