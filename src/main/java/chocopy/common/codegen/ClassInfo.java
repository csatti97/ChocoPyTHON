...
/** Information for code generating a class. */
public class ClassInfo extends SymbolInfo {
    ...
    /** Adds an attribute described by ATTRINFO. */
    public void addAttribute(AttrInfo attrInfo) {
        this.attributes.add(attrInfo);
    }

    /**
     * Adds a method described by FUNCINFO, overriding any inherited method of that name if
     * necessary.
     */
