...
public class Utils {
    /**
     * Returns resource file FILENAME's contents as a string. FILENAME can refer to a file within
     * the class hierarchy, so that a text resource in file resource.txt in the
     * chocopy.common.codegen package, for example, could be referred to with FILENAME
    ...
    /**
     * Returns an exception signalling a fatal error having a message formed from MSGFORMAT and
    ...
    /**
     * Returns the string S padded with FILL to TOLEN characters. Padding is on the left if
